                ...
                <ul>
                    ...
                    <li>
                        <form action="#" method="post" id="log">
                            <button class="button" style="vertical-align:middle" formaction="#"><span>Logout </span></button>
                        </form>
                    </li>
                </ul>
            </nav>
        ...
        <div class="page-content">        
            <section id="header">
				<div class="inner">
					...
					<ul class="actions special" style="margin-left: -48px;">
                        <button class="button" style="vertical-align:middle; background: #003C4D; padding: 10px;" formaction="#"><span>Donate Now </span></button>
					</ul>
				</div>
			</section>
            ...
            <section id="extra" class="content-section">
                    <button class="button" style="vertical-align:middle; background: #003C4D; padding: 10px; margin-left: 15px;" formaction="#"><span>Change Password</span></button>
                    <button class="button" style="vertical-align:middle; background: #003C4D; padding: 10px; margin-left: 15px;" formaction="#"><span>Update Details</span></button>
                    <button class="button" style="vertical-align:middle; background: #003C4D; padding: 10px; margin-left: 15px;" formaction="#"><span>Change E-mail</span></button>
			</section>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card-content">
                    ...
                    <a href="#" class="btn-card" style="margin: 0.56em;">Click here</a>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-content">
            ...
            <section id="header">
				<div class="inner">
					...
					<ul class="actions special" style="margin-left: -48px;">
                        <button class="button" style="vertical-align:middle; background: #003C4D;  padding: 10px;" formaction="needhelp.php"><span>Privilege Us </span></button>
					</ul>
				</div>
			</section>
