...
<body>
    ...
    <div class="header">
        <img src="./src/assets/images/back-head-white.svg" class="back-button" href="./index.php">
        <img src="./src/assets/images/logo1.png" class="logo">
    </div>

    <div class="viewer">
        <img src="./src/assets/images/gallery-images/dc.jpg" class="active-img">
    </div>

    <div class="scroller">
        <img src="./src/assets/images/gallery-images/dc.jpg" class="image-card active">
        ...
        <img src="./src/assets/images/gallery-images/cs.jpg" class="image-card">
