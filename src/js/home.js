$('body').ready(() => {
    ...
    $('body').scroll((e) => {
        ...
        $('.timeline .cubes.top-right').css({'transform': 'translate(1vh, calc(-5vh + ' + String(timeline_top*speed*0.9) + 'px))'});
        $('.timeline .cubes.bottom-left').css({'transform': 'scale(-1, 1) translate(-30px, calc(85vh + ' + String(timeline_top*speed*1.3) + 'px))'});
        $('.timeline .cubes.bottom-right').css({'transform': 'translate(0, calc(95vh + ' + String(timeline_top*speed*1.5) + 'px))'});

        // $('.anusmriti .cubes.top-left').css({'transform': 'scale(-1, -1) translate(1vh, calc(1vh - ' + String(anusmriti_top*speed) + 'px))'});
        // $('.anusmriti .cubes.bottom-right').css({'transform': 'translate(0, calc(80vh + ' + String(anusmriti_top*speed*1.2) + 'px))'});
